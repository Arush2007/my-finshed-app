    ...
    renderVideo = () => {
        ...
        >
            <View style={styles.iconContainer}>
                <Image source={require("../assets/boi3.gif")} style={{ width: 50, height: 50 }}></Image>
            </View>
        </TouchableOpacity >
    }
                ...
                <View style={styles.container}>
                    ...
                    <ImageBackground source={require('../assets/boi.gif')} style={styles.backgroundImage}>
                        <View style={{ flex: 0.15, justifyContent: "center", textAlign: "center" }}>
                            <Text style={styles.routeText}>Final rule is that Always respect boi ainsley and treat him how you treat your chicken, nicley</Text>
                        </View>
